...
exports.isPrimitiveType = exports.isPrimitiveTypeString = exports.typeMap = exports.findTypeMap = exports.isUnions = exports.removeOptional = exports.isOptional = exports.findNonCollidingName = exports.exitOrError = exports.getCriteria = exports.prettyJson = exports.isValidCriteriaProperty = exports.indent = exports.propagateTarget = exports.appendTarget = exports.initialCaps = exports.updateNamespace = exports.deepClone = exports.wrap = exports.isRelativePath = exports.caseInsensitiveSorter = exports.requireDefaultOrPackage = void 0;
const immutability_helper_1 = require("immutability-helper");
const util_1 = require("util");
const logging_1 = require("./logging");
const model_1 = require("./model");
const req = require;
const prettifyJson = req("prettify-json");
...
function caseInsensitiveSorter(mapper) {
    return (source, target) => mapper(source).toLowerCase().localeCompare(mapper(target).toLowerCase());
}
