...
exports.buildgRPCContext = exports.messageType = exports.GRPC = exports.typeName = void 0;
...
function typeName($nschemaType, _nschema, namespace, _name, context) {
    let result;
...
function messageType(nschema, $context, message) {
    ...
    if (dataItems.length === 0) {
        ...
        return (`{ ${dataItems
            .map((item, itemIndex) => {
            return `${item.name || `item${itemIndex}`}: ${typeName(item.type, nschema, "", "", $context)}`;
        })
