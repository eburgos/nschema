    ...
    init(nschema) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            templates.consumer = (data) => {
                return serviceConsumer_1.render(nschema, data.$context, data);
            };
            templates["consumer-serverless"] = (data) => {
                return serviceConsumerBase_serverless_1.render(nschema, data.$context, data);
            };
            templates["consumer-serverless-exports"] = (data, nschemaInstance, context) => {
                return serviceConsumer_serverless_1.render(nschemaInstance, context, data, data.target);
            };
            templates.producer = (data, nschemaInstance, context) => {
                return serviceProducer_1.render(nschemaInstance, context, data, data.target);
            };
            return Promise.all([
                {
                    bind: "rest",
            ...
            ].map((serviceType) => __awaiter(this, void 0, void 0, function* () {
