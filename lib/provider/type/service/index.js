        ...
        if (parentConfig.operations) {
            ...
            for (const p in operations) {
                if (operations.hasOwnProperty(p)) {
                    message_1.processMessage(operations[p].inMessage, nschema, parentConfig.namespace || "");
                    message_1.processMessage(operations[p].outMessage, nschema, parentConfig.namespace || "");
                }
            }
        }
